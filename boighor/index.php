...
<style>
    ...
    .custom-alert-content button {
        ...
        border: none;
        border-radius: 5px;
        background-color: #ce5872; /* Customize the button color */
        color: white;
        cursor: pointer;
    }
    .custom-alert-content button:hover {
        background-color: #b84b62; /* Darker shade on hover */
    }
</style>
</head>


<!-- Mirrored from htmldemo.net/boighor/boighor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2024 19:14:29 GMT -->
...
<?php
    ...
    <form id="newsletterForm" onsubmit="return handleSubscription(event);">
...
<div id="custom-alert" class="custom-alert" style="display: none;">
    ...
    function handleSubscription(event) {
        ...
        if (email === "") {
            ...
            showAlert("Subscription is being processed. Thank you!");
            emailInput.value = ""; // Reset the input field for a new email entry
        }
    }
