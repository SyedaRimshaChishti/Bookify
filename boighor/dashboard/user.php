...
$totalUsers = $conn->query("SELECT COUNT(*) as count FROM user_deatail")->fetch_assoc()['count'];
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['re_password']); ?></td>
                        <td><?php echo htmlspecialchars($row['email']); ?></td>
                        <td><?php echo htmlspecialchars($row['phone']); ?></td>
                        <td>
                            <a href="edit_user.php?id=<?php echo $row['user_id']; ?>" class="btn btn-warning btn-sm mb-2">Edit</a>
                            <a href="delete_user.php?id=<?php echo htmlspecialchars($row["user_id"]); ?>" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
